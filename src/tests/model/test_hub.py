...
def test_hub_creates_with_required_fields():
    hub = Hub(name="start")
...
def test_hub_rejects_empty_name():
    with pytest.raises(ValidationError):
        Hub(name="")


def test_hub_accepts_custom_coordinates_and_color():
...
def test_hub_color_defaults_to_none():
